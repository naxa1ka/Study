...
void MaxArray(int** ARRAY, int N, int M,int *max);  //поиск максимума среди строк в которых есть хотя бы один положительный элемент
...
void MaxArray(int** ARRAY, int N, int M, int *max) {
	for (int i = 0; i < N; i++) {
